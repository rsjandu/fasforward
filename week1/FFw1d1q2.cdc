...
pub fun main() {
  ...
  let canvasX = Canvas(
    ...
    var minter <- create Printer()

    var pictureX <- minter.print(canvas: canvasX)
    destroy pictureX

    var pictureX2 <- minter.print(canvas: canvasX) //should give error
    destroy pictureX2

    var pictureY <- minter.print(canvas: canvasY)
    destroy pictureY
